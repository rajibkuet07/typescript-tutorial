...
var coreTypes = function (a, b, print, phrase) {
...
// Its not mandatory!
var numVar = 100; // its already constant and not changeable
var numVarChangeable; // for this you can assign anything you want
numVarChangeable = 5;
...
var hobbies = ['Badminton', 17]; // OK if we do not assign type
var favoriteSports;
...
// Just like array
var role = [2, 'author']; // is just a normal array
role[2] = 'Rajib'; // Ok for array
var roleTuple; // length is 2 and first item is number and second number is string
...
var roleEnumSolved = Role.AUTHOR;
...
// Union type using any literal(a text value) instead of primitive type.
var literal;
var literalExample = 'as-number';
if (literalExample === 'as-number')
    console.log('Literal as number');
literalExample = 'as-text';
if (literalExample === 'as-text')
    console.log('Literal as text');
/**
 * ===== Type aliases
 * using 'type' keyword
...
function functionReturnType(a, b) {
    return a + b;
}
var functionReturnTypeVoid = function (a) {
...
var functionAsCallback = function (a, b, cb) {
    return cb(a, b);
};
console.log(functionAsCallback(12, 13, addTs));
console.log(functionAsCallback(13, 14, function (a, b) {
    return a + b;
}));
/**
 * ===== Unknown Types
...
function neverType(message, code) {
